...
#define MAXFAC 13    /* maximum number of factors in factorisation of n */
...
static void factorise(int n, int ifac[MAXFAC+2], const int ntryh[NSPECIAL])
  /* factorise n in factors in ntryh and rest. On exit,
